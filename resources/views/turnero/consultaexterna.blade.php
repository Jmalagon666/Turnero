...
<body>
    <div class="header">
        <div class="row">
            ...
            <div class="col">
                <div class="imagen">
                    <img  src="logo.jpg" width="150px" height="90px">
                </div>
            </div>
            <div class="col">
                <div>
        ...
        <div class="row">
                <div class="col-sm-6">
                  <div>
                    ...
                    <form action="{{route('ingresardocumento')}}" method="POST">
                        ...
                        <h2>
                            <button type="submit" value="P" id="n1" class="boton_menu">CARDIOLOGÍA</button>
                        </h2>
                    </form>
                    </div>
                </div>
            ...
            <div class="col-sm-6">
                <div>
                    ...
                    <form action="{{route('ingresardocumento')}}" method="POST">
                        @csrf
                        <input type="hidden" name="general" value="{{$request->general."N"}}" id="n1" >
                        <h2>
                            <button type="submit" value="P" id="n1" class="boton_menu">NEUROLOGÍA</button>
                        </h2>
                    </form>
                    </div>
                </div>
            ...
            <div class="col-sm-6">
                <div>
                    ...
                    <form action="{{route('ingresardocumento')}}" method="POST">
                        @csrf
                        <input type="hidden" name="general" value="{{$request->general."OE"}}" id="n1" >
                        <h2>
                            <button type="submit" value="P" id="n1" class="boton_menu">OTRAS ESPECIALIDADES</button>
                        </h2>
                    </form>
                    </div>
                </div>
